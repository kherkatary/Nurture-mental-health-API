...
var serverUrl = process.env.SERVER_URL || 'http://localhost:8080';
...
node_cron_1.default.schedule('*/30 * * * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get(serverUrl)];
            case 1:
                response = _a.sent();
                console.log("Server ping successful: Status ".concat(response.status));
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
                console.error('Failed to ping server:', err_1.message);
                return [3 /*break*/, 3];
