...
var hashingPassword = function (password) { return __awaiter(void 0, void 0, void 0, function () {
    var saltRounds, hashedPass, err_1;
...
var passwordCompare = function (password, hashedPassword) { return __awaiter(void 0, void 0, void 0, function () {
    var comp, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                err_2 = _a.sent();
                console.log("error comparing password: ".concat(err_2));
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
